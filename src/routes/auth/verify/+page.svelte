...
<div class="mx-auto max-w-md px-4 py-16 text-center">
  <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8">
    ...
    {:else if data.status === 'verified'}
      ...
      <p class="mb-4 text-slate-300">Your workspace is active. Check your email for your login credentials.</p>

      <div class="bg-white/5 border border-white/10 rounded-xl p-4 mb-6 text-left">
        <p class="text-xs uppercase text-slate-500 mb-3 font-medium tracking-wide">n8n Editor Credentials</p>
        <div class="space-y-2">
        ...
        <p class="text-xs text-yellow-400/80 mt-3">All credentials were sent to your email. Save them.</p>
      </div>
